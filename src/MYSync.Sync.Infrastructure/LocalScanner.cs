...
public sealed record FileFingerprint(long Length, DateTime LastWriteUtc, string Hash);
/// <summary>
...
/// </summary>
public sealed class LocalScanner(IDictionary<string, FileFingerprint>? cache = null)
{
                ...
                foreach (var path in Directory.EnumerateFileSystemEntries(directory))
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            if (cache is not null) cache[path] = new(size, stamp, hash);
